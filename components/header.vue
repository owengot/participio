  ...
  <nav class="navBar">
    <nav class="wrapper">
      ...
      <ul>
        ...
        <li> <a
            href="http://edgeryders.eu/t/ssna-on-collaborative-improvisation-project-outline"
            target='_blank'
          >Collaborative Improv with SSNA</a></li>
        <li> <a
            href="http://edgeryders.eu/t/what-does-the-participio-software-need-to-be-useful-for-artistic-co-creation"
            target='_blank'
          >Co-Creation Tools for Artists</a></li>
      </ul>
    </nav>
  </nav>
...
@media screen and (max-width: 768px) {
  ...
  nav ul li a {
    ...
    border-radius: 10px;
    border: none;
    border-bottom: 0.75px solid rgb(87, 87, 87);
  }
  .navBar {
...
#particip_io {
  background: url("/particip_io.png") no-repeat;
...
.navbar1 #er_logo:after {
  background: rgba(255, 68, 0, 0.432);
}
